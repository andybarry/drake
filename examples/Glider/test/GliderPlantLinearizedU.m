classdef GliderPlantLinearizedU < DrakeSystem
...
%    talon_b = [0 -.043]'; % talon coordinates, about cg in body coords (meters).
  ...
  methods
    function obj = GliderPlantLinearizedU()
    ...
    function [xdot,df] = dynamics(obj,t,x,u)
      ...
      Fe_linearized = dFe_du * u(1) + Fe_affine;
