  ...
  methods
    ...
    % Provides the DrakeSystem interface to the manipulatorDynamics.
      ...
      if (nargout>1)
        ...
        Hinv = pinv(H);  % pinv is more expensive than inv, but it performs more gracefully in some odd situations (like when I set the inertia of the elevator = 0 in the glider example)
